                     ...
                     $price = $row["price"];
                       ...
                       $data .=
                         "<tr id='cartItems'>
                             <td><img src='$row[img_path]' width='25%' height='25%'></td>
                            <td id='price$id'>$price</td>
                             <td><input type='number' value = '$quantity' id='quantity$id'></td>
                             <td class='sub-total' id='subTotal$id'>$subTotal</td>
                         </tr>";
                   }
               }
...
$data .="</tbody></table>
             <hr>
             <h3 align='right'>Total: &#x20B1; <span id='grandTotal'>$grand_total </span><br><button class='btn btn-success'>Place Order</button></h3>
             <hr>";
echo $data;
?>
    	</div>
